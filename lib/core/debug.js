...
const {
  ...
  get_mem_tail,
  get_tick_changed, get_tick_deep, tick_deep_inc, tick_deep_dec, tick_start, get_box_deps, get_box_rels, get_box_invalid, box_deep_invalidate, get_box_expr, tick_finish,
  b0: box_value_create,
  ...
  bc: box_view_start,
  bd: box_view_finish,
  extract_ptr: mem_extract,
  extract_set: set_extract,
  extract_arr: arr_extract,
  extract_map: map_extract,
  extract_map_of_arr: map_of_arr_extract,
} = core;
