...
const {
  memory,
  set_create, set_size, set_add, set_has, set_delete, set_free, set_data_ptr,
  ...
  mem_tail,
  tick_deep_inc, tick_start
} = core;

export * from ".";
export {
  mem_extract,
  set_create, set_size, set_add, set_has, set_delete, set_free, set_extract,
