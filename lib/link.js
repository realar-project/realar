import { box_entry_start, box_entry_finish, box_collection_free, box_free } from "./box";
...
function get_current_link_scope_id() {
  return scope_current_id;
}
